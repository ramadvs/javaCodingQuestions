...
public class countOneSpecificCharacterOccurance {
...
public void charcterOccurance (String str, String x)
	...
	public static void main(String[] args) {
		...
		countOneSpecificCharacterOccurance cntspchr = new countOneSpecificCharacterOccurance();
		
		cntspchr.charcterOccurance("testbestrest", "t");
